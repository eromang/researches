"""Train CyberScale Phase 3 O-model (operational severity classifier, ModernBERT 4-class).
...
class CVEDataset(Dataset):
    """Tokenised CVE operational inputs with integer class labels."""
...
def train(
    ...
    # Support string labels (O1-O4) via label_map, or integer labels
...
# ---------------------------------------------------------------------------
def main() -> None:
    parser = argparse.ArgumentParser(description="Train CyberScale Phase 3 O-model (operational severity)")
    parser.add_argument(
        "--data",
        type=str,
        default="training/data/operational_training.csv",
        help="Path to training CSV (input_text, label)",
    )
    parser.add_argument(
        "--config",
        type=str,
        default="training/configs/operational_cls.json",
        help="Path to operational_cls.json config",
    )
    parser.add_argument(
        "--output",
        type=str,
        default="data/models/operational",
