# CyberScale Phase C — Multi-Entity Aggregation Benchmark
...
| O-model accuracy | > 70% | 100.0% | PASS |
...
| ME-007 | Kaseya-style MSP ransomware cascade | 4 | T3/O4 | T3/O4 | cyber_crisis | ok |
| ME-008 | EU water treatment SCADA compromise | 2 | T3/O3 | T3/O3 | large_scale | ok |
| ME-009 | Cross-border railway signalling sus | 3 | T4/O3 | T4/O3 | cyber_crisis | ok |
| ME-010 | EU DNS infrastructure DDoS campaign | 3 | T3/O4 | T3/O4 | cyber_crisis | ok |
...
| ME-014 | Airport IT system ransomware | 2 | T3/O3 | T3/O3 | large_scale | ok |
| ME-015 | Trust service provider key compromi | 3 | T4/O3 | T4/O3 | cyber_crisis | ok |
| ME-016 | Pharmaceutical IP theft campaign | 3 | T2/O3 | T2/O3 | large_scale | ok |
| ME-017 | Satellite ground station jamming | 2 | T2/O3 | T2/O3 | large_scale | ok |
| ME-018 | Regional government sustained ranso | 2 | T4/O2 | T4/O2 | large_scale | ok |
...
| ME-021 | Port logistics ransomware | 3 | T3/O3 | T3/O3 | large_scale | ok |
| ME-022 | Financial market data feed manipula | 2 | T2/O3 | T2/O3 | large_scale | ok |
| ME-023 | Medical device firmware backdoor | 3 | T2/O3 | T2/O3 | large_scale | ok |
| ME-024 | Postal service minor data access | 2 | T2/O2 | T2/O2 | significant | ok |
| ME-025 | Multi-country search engine defacem | 2 | T2/O3 | T2/O3 | large_scale | ok |
...
| ME-031 | Social network and marketplace mino | 2 | T2/O1 | T2/O1 | significant | ok |
| ME-032 | Cross-border electricity and gas di | 3 | T3/O3 | T3/O3 | large_scale | ok |
| ME-033 | Managed security provider supply ch | 4 | T3/O3 | T3/O3 | large_scale | ok |
| ME-034 | Nordic banking trojan campaign | 2 | T3/O3 | T3/O3 | large_scale | ok |
| ME-035 | EU cloud region sustained outage | 5 | T4/O4 | T4/O4 | cyber_crisis | ok |
| ME-036 | Iberian electricity grid cyber intr | 2 | T3/O2 | T3/O2 | large_scale | ok |
| ME-037 | Multi-sector espionage via MSP comp | 4 | T3/O3 | T3/O3 | large_scale | ok |
| ME-038 | Drinking water contamination scare  | 2 | T2/O2 | T2/O2 | significant | ok |
...
| ME-041 | Hospital ransomware with fatality | 2 | T4/O1 | T4/O1 | large_scale | ok |
...
| ME-047 | Multi-entity shipping and port cybe | 4 | T3/O3 | T3/O3 | large_scale | ok |
